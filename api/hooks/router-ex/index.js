...
module.exports = function routerEx(sails) {
  return {};
};
//
...
//    },
//
//    buildRoutesByController: function() {
...
//    sails.log.verbose('Loading extended router middleware...');
//
...
//      sails.once('middleware:registered', hook.buildRoutesByController);
//
//      return cb(err);
//    });
//  }
